...
train_data <- readr::read_csv(file = "./05_datasets/test_data_with_all_test_immuno_stratify.csv")
...
ggsave(filename = "./04_Preprocessing_results/Validation_data_plots/receptor_sequence_comparison_plot_train_only.pdf", 
...
ggsave(filename = "./04_Preprocessing_results/Validation_data_plots/epitope_sequence_comparison_plot_train_only.pdf", 
...
ggsave(filename = "./04_Preprocessing_results/Validation_data_plots/epitope_length_comparison_plot_train_only.pdf", 
