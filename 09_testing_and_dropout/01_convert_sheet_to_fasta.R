...
writeFasta(receptor_full_length, "./09_testing_and_validation/dropout_case/receptor_full_length_dropout_test.fasta")
...
receptor_full_length <- receptor_full_length %>% distinct(Sequence, .keep_all = TRUE)
writeFasta(receptor_full_length, "./09_testing_and_validation/test_data_set/receptor_full_length_model_validation.fasta")
