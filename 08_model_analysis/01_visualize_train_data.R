...
ggsave(filename = "./04_Preprocessing_results/Train_data_plots/receptor_sequence_comparison_plot_train_only.pdf", 
...
ggsave(filename = "./04_Preprocessing_results/Train_data_plots/epitope_sequence_comparison_plot_train_only.pdf", 
...
ggsave(filename = "./04_Preprocessing_results/Train_data_plots/epitope_length_comparison_plot_train_only.pdf", 
