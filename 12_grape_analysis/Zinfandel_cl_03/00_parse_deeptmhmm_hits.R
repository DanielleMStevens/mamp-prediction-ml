...
input_file <- "11_grape_analysis/Zinfandel_cl_03/combined_deeptmhmm_predictions.txt"
output_file <- "11_grape_analysis/Zinfandel_cl_03/filtered_tm_sp_proteins.fasta"
